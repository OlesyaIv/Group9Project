...
public interface ActProxyAdministrator extends ActProxyAuthenticated {
	 ...
	 */
	public PtBoolean oeAddCoordinator(DtCoordinatorID aDtCoordinatorID, DtLogin aDtLogin,DtPassword aDtPassword, DtPhoneNumber aDtPhoneNumber) throws RemoteException, NotBoundException;
