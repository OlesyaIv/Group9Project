...
public class AdminController extends AbstractUserController {
	 ...
	 */
	public PtBoolean oeAddCoordinator(String coordinatorID, String login, String password, String phone) throws ServerOfflineException, ServerNotBoundException, IncorrectFormatException{
		if (getUserType() == UserType.Admin){
			...
			DtPhoneNumber aDtPhoneNumber = new DtPhoneNumber(new PtString(phone));
	...
	public DtQualityDataset getQualityDataset() throws ServerOfflineException, ServerNotBoundException
	{
		if (getUserType() == UserType.Admin){
			ActProxyAdministratorImpl actorAdmin = (ActProxyAdministratorImpl)getAuth();
			try {
				return actorAdmin.getQualityDataset();
			} catch (RemoteException e) {
				Log4JUtils.getInstance().getLogger().error(e);
				throw new ServerOfflineException();
			} catch (NotBoundException e) {
